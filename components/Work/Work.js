    ...
    return (
        ...
        scroll-mt-20">
            ...
            <motion.p
                ...
                showcasing my expertise in front-end and back-development.
            </motion.p>
            ...
            <motion.div
                ...
                className="grid [grid-template-columns:repeat(auto-fit,_minmax(200px,_1fr))] my-10 gap-5 dark:text-black">
            ...
            ${resolvedtheme === 'dark'
                        ? 'hover:bg-[#2a004a]/50 text-white'
                        : 'hover:bg-[#fcf4ff] text-[#2a004a]'} 
             `}
            >
                Show more <Image src={resolvedtheme === '' ? assets.right_arrow_bold_dark : assets.right_arrow_bold} alt="right-arrow" className="w-4" />
            </motion.a>
